...
- ✓ **(v0.2, 2026-07-17) El funding real 2021-26 NO destruyó el edge de tendencia — lo mejoró frente al modelo pesimista.** La evidencia del laboratorio es consistente con: el coste real de funding para una cesta long/short de tendencia fue MENOR que el supuesto uniforme de 0.01%/8h (FULL: NET 27.3% real vs 24.0% modelado; todas las ventanas mejoran). Mecanismo (CORREGIDO el 2026-07-18 tras revisión cruzada, un día después de escribirse — la versión inicial atribuía el ahorro a "cobrar carry en alts" y era FALSA): la cesta pagó funding en los 5 símbolos y en ambos lados (longs −$413, shorts −$40, total −$453 vs ~−$776 del modelo uniforme); el ahorro vino de que el supuesto uniforme sobrecargaba a toda posición siempre, no de cobrar nada. Hallazgo mecanístico clave: **las posiciones de tendencia están adversamente seleccionadas contra el promedio incondicional de funding** — la estrategia se pone larga en regímenes eufóricos (funding más caro) y estaba corta en los crashes donde el funding era negativo (pagando también); el promedio incondicional del mercado (p. ej. SOL −2.8% anualizado) NO es el funding que paga una estrategia direccional. Confianza alta para el período medido; el futuro puede diferir. Contraste con la predicción P4 de HIPOTESIS_ECONOMICA ("el edge se comprime con funding extremo"): en episodios extremos puntuales sigue abierta, pero como efecto agregado histórico quedó refutada la versión fuerte — el funding no fue el viento en contra temido. Basado en: exp-008 (dataset APTO A-02, hashes congelados, paridad verificada). Refutaciones: ninguna a la fecha. La "mayor incógnita de magnitud" declarada desde el VEREDICTO original queda CERRADA para 2021-26.
