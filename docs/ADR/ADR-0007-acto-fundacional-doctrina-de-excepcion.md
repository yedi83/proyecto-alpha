...
- **Fecha:** 2026-07-18
- **Estado:** **ACEPTADA — RATIFICADA por el Investigador Principal el 2026-07-18**, tras dictamen A-04 v2 CONFORME (`ADR-0007_DICTAMEN_A04_v2.md`). Secuencia §4.7 cumplida en orden: Propuesta (07-18) → dictamen NO CONFORME (V-201) → cura v2 → dictamen CONFORME → ratificación → efectos ejecutados en el mismo acto (Constitución principio 17, Protocolo §6, ficha fuente única, punteros, erratum exp-008, nota en plantilla ADR, convalidaciones).
...
- **Versión:** **v2 (2026-07-18) — cura de V-201/C-007** (dictamen A-04, `ADR-0007_DICTAMEN_A04.md`). Único cambio de fondo: la disposición transitoria de la Parte III (principio 17) exime ahora de forma **expresa** al caso fundacional de los requisitos de admisibilidad **(9)(a) y (9)(b)** —en paralelo al tratamiento del (4) «hacia adelante»—, declarando que el régimen de admisibilidad del (9) queda desplazado por la transitoria **solo para este caso** y rige íntegro para todo caso posterior. Ninguna otra línea normativa se modifica. **v1** = redacción original del 2026-07-18, conservada en el historial de git (commit `5dbee73`; el fichero de respaldo fue eliminado por redundante con el historial — corrección de metadato 2026-07-18, observación del dictamen v2).
