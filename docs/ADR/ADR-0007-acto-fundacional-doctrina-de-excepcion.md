...
- **Versión:** **v2 (2026-07-18) — cura de V-201/C-007** (dictamen A-04, `ADR-0007_DICTAMEN_A04.md`). Único cambio de fondo: la disposición transitoria de la Parte III (principio 17) exime ahora de forma **expresa** al caso fundacional de los requisitos de admisibilidad **(9)(a) y (9)(b)** —en paralelo al tratamiento del (4) «hacia adelante»—, declarando que el régimen de admisibilidad del (9) queda desplazado por la transitoria **solo para este caso** y rige íntegro para todo caso posterior. Ninguna otra línea normativa se modifica. **v1** = redacción original del 2026-07-18 (conservada como `ADR-0007-acto-fundacional-doctrina-de-excepcion.v1-backup-2026-07-18.md`).
