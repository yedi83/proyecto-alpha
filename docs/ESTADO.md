...
|---|---|---|---|
| [H-001](INVESTIGACION/hipotesis/H-001-canal-donchian.md) | Canal de Donchian 512 (perp USDT) | Fase A APROBADA 6/6 (07-14). Fase B: corte del 07-14 **COMPROMETIDO** (contaminación: ensayo con keys idénticas operó la misma cuenta demo → doble bot). **RE-CORTE limpio 2026-07-16, corte 15:27:33 UTC** (`fase_B/ACTA_RECORTE_2026-07-16.md`): keys del ensayo neutralizadas, cuenta aplanada, tarea `faseB_donchian` (python directo, IgnoreNew), datos 07-14→16 anulados, reloj de 1 mes reiniciado. Corriendo: demo, eq=750, abiertas=0. **Estatus epistemológico: CUESTIONADA (ADR-0006, 07-17)** — exp-004 disparó letal de lookback y el override por nota se formalizó retroactivamente; Fase C ahora condicionada a exp-008 (funding real) en R0 + cero disparos letales nuevos; un 2º disparo = retiro operativo automático | ⏳ En validación — **Fase B corriendo (re-cortada) · hipótesis CUESTIONADA** |
